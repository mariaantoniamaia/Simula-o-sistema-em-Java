...
public class PedidoInstalacaoProvisoria extends JPanel {
	 ...
	 * Create the panel.
	 */
	public PedidoInstalacaoProvisoria() {
		setBackground(new Color(223, 181, 249));

		setBounds(100, 100, 665, 658);
		setLayout(new MigLayout("", "[][grow]", "[][50px][][][30px][][][30px][][][30px][][][30px][][][::100px,grow][][]"));
		
		labelTitulo = new JLabel("Solicitação de equipamentos de TIC para evento");
